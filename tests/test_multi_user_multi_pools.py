...
def test_multi_user_multi_pools(deployer, users, vaults, badger_tree, badger, want):
    ...
    pid0 = (badger_tree.add(10, vaults[0], {"from": deployer})).return_value
    pid1 = (badger_tree.add(30, vaults[1], {"from": deployer})).return_value
    ...
    expected_badger_emissions = (blocks_spent *
                                 BADGER_PER_BLOCK) - (BADGER_PER_BLOCK * 0.75)
